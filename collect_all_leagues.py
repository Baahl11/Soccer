"""
Script to collect corner and formation data from all supported leagues.
"""
import os
from corner_data_collector_v2 import FootballDataCollector
...
def main():
    ...
    try:
        all_data = collector.collect_multiple_leagues(season)
