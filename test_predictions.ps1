Write-Host "Testing voting ensemble prediction..."
$pythonCode = @"
...
$pythonCode | Out-File -FilePath "c:\Users\gm_me\Soccer\test_pred.py" -Encoding utf8
python "c:\Users\gm_me\Soccer\test_pred.py"
