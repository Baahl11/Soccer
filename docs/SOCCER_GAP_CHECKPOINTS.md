...
This is the authoritative resumption point while v3.58 awaits a persisted natural tick.
...
- **Next operational patch after v3.58 validation:** separate EARLY_RESEARCH from true T-90, allow a market snapshot only after a SPORT-FIRST shortlist, then preserve T-90/T-40/T-20/T-10/CLOSE lifecycle. Working label: v3.59 Operational Market Lifecycle; this is not a new numbered roadmap checkpoint.
...
5. Continue #44 with score-derived joint families; keep non-score correlations blocked until their individual models have adequate OOS evidence.
