...
#37 Tactical Style — formalize only defensible style descriptors from verified formation and persisted match-stat trends; press/block/transition remain NOT_VERIFIED until spatial/PPDA evidence exists.