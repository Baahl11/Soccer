...
#38 Rest — derive days since last completed match from existing recent-fixture data, attach live with zero extra provider calls, and keep effect weight zero until OOS thresholds are validated.