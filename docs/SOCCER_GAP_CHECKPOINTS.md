...
#40 Travel — use only verified venue/city/country metadata; do not fabricate distance, timezone shift or altitude without defensible coordinates/venue data.